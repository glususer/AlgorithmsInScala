...
// Hint, contribution of an element in total subseq = element *(no of subsets where this is max - no of subsets where this is min)=
// no of subsets where this is max = 2^i whr i is the no of elements that are lesser than ele i.e the index in sorted arrat of this ele
